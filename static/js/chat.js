...
const addChatBubble = (message, sender, type) => {
    ...
    const shouldScroll = content.scrollTop + content.clientHeight === content.scrollHeight;
...
document.querySelector('.help').addEventListener('click', (event) => {
    ...
    messageHelpText.innerHTML = "<p>Poți avea o discuție lejeră cu mine! Încearcă să îmi spui ceva!</p><p>Sunt specializat în orice lege! Întreaba-mă despre ce ți-ar plăcea să aflii!</p>";
